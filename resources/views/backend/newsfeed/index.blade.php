            ...
            <table id="dtBasicExample" class="table table-striped table-bordered table-sm blueTable" cellspacing="0" width="100%">
                    <thead class="text-center bg-dark text-white" >
                      <tr >
                        ...
                        <th class="th-lg"  width="18%" style="font-size:20px;">
                           Action
                        </th>
                    ...
                    @foreach ($data as $datas)
                      <tr>
                        ...
                        <td class="font-weight-bold"> {{$datas->newsfeed_title}}</td>

                        <td>
                            <span class="float-left">
                                    <a href="/newsfeed/{{$datas->id}}"  class="badge badge-success btn-md p-2"  style="border-radius:20px"><i class="fa fa-eye" aria-hidden="true"></i> View</a>
                            </span>
                             <span  class="float-right">
                                <form action="/newsfeed/{{$datas->id}}" method="POST">
                                    @csrf
                                    @method("DELETE")
